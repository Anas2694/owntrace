...
Early development. The responsive public landing page, password-based authentication, privacy-first onboarding, secure Gmail connection/sync foundation, and deterministic account-discovery pipeline are implemented. Account browsing and other product integrations are still in progress.
