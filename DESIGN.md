...
status semantics:
  high: "Vibrant red (#ff3b30) with white text. Use for immediate-attention privacy risks and high-priority action badges."
  medium: "Warning yellow (#f2c978) with deep-violet text. Use for items that need review but are not urgent."
  good: "Electric lime (#c2ef4e) with deep-violet text. Use for healthy or safe states."
